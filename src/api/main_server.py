...
# 导入各个服务类
from .device_data_server import DeviceDataServer
from .community_real_time_data_server import CommunityRealTimeDataServer
from .user_data_server import UserDataServer
from .sleep_statistics_server import SleepStatisticsServer
...
class AeroSenseMainServer:
    ...
    def __init__(self, sql_config_path: str = SQL_CONFIG_PATH):
        ...
        # 初始化各个服务
        self.device_service = DeviceDataServer(sql_config_path)
        self.community_service = CommunityRealTimeDataServer(sql_config_path)
        self.user_service = UserDataServer(sql_config_path)
        self.sleep_service = SleepStatisticsServer(sql_config_path)
    ...
    def _register_all_services(self):
        """注册所有服务的路由"""
        # 注册设备服务路由
        self.device_service.register_routes(self.app)
        ...
        # 注册睡眠服务路由
        self.sleep_service.register_routes(self.app)
...
if __name__ == "__main__":
    ...
    # 证书文件路径
    cert_file = str(ROOT_DIRECTORY.parent / "cert" / "shunxikj.com.crt")
    key_file = str(ROOT_DIRECTORY.parent / "cert" / "shunxikj.com.key")
